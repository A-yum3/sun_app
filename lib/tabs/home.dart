...
class _HomeState extends State<Home> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _events = {
      ...
      _selectedDay.subtract(Duration(days: 27)): ['Event E1'],
      ...
      _selectedDay.subtract(Duration(days: 16)): ['Event A3', 'EventB3'],
      ...
      _selectedDay.subtract(Duration(days: 2)): ['Event A6', 'EventB6'],
      _selectedDay: ['Event A7', 'EventB7', 'Event C7', 'EventD7'],
